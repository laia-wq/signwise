...
export class TrackingReport {
 ...
 push(now,packet){
  ...
  if(now-this.started>=5000||this.frames.length>=65){this.stop('capture finished');return;}
 ...
 export(){return {format:'signwise-tracking-v1',appRevision:10,letter:this.letter,reason:this.reason,frames:this.frames};}
}
